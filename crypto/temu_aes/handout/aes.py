...
class AES:
    ...
    def expand_key(self, key: bytes) -> list:
        ...
        for r in range(self.n_rounds):
            ...
            for i in range(4, 16):
                round_key.append(round_keys[-1][i] ^ round_key[-4])
            round_keys.append(round_key)
        return round_keys

    def sub_bytes(self, m: list) -> list:
        return list(sbox[mc] for mc in m)

    def inv_sub_bytes(self, c: list) -> list:
        return list(isbox[cc] for cc in c)

    def shift_rows(self, m: list) -> list:
    ...
    def inv_shift_rows(self, c: list) -> list:
    ...
    def mix_columns(self, m: list) -> list:
    ...
    def inv_mix_columns(self, c: list) -> list:
        for i in range(0, 16, 4):
    ...
    def add_round_key(self, m: list, r: int) -> list:
        return list(xor(bytes(m), self.round_keys[r]))
